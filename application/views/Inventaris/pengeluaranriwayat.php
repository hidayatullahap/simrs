...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <a href="<?php echo base_url('/inventaris/pengeluaran'); ?>"><font color='black'><strong>Riwayat barang keluar</strong></font></a>
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <div class="form-group row">
                            <div class="col-xs-2">
                                <button onclick="window.location.href='<?php echo base_url('/inventaris/pengeluaran/layanan') ?>'" type="button" class="btn btn-info btn-md" id="buttonTambah" data-toggle="modal" data-target="#addForm">Tambah Barang Keluar</button>
                            </div>

                            <form id="formSubmit" method="post" action="<?php echo base_url('/inventaris/pengeluaran') ?>">
                    ...
                    <span><i>*Search box boleh kosong</i></span>
                        ...
                        if (isset($totalPages)) {
                            $entity->tampilkan('inventaris/pengeluaran',$currentPage, $totalPages);
                        }
                        ?>
                    </div>
