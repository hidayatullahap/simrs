...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <a href="<?php echo base_url('/inventaris/pengeluaran'); ?>"><b> Pengeluaran Barang </b></a><br>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                            ...
                            <form method="post" action="<?php echo base_url('/inventaris/pengeluaran/tambahPengeluaranStok')?>">
