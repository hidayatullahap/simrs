...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <a href="<?php echo base_url('/depo/permintaandepo'); ?>"><font color='black'><strong>Informasi stok depo</strong></font></a>
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <div class="form-group row">
                            <form method="post" action="<?php echo base_url('depo/permintaandepo') ?>">
                            <div class="col-xs-2">
                            <button onclick="window.location.href='<?php echo base_url('/depo/permintaandepo/layanan') ?>'" type="button" 
                            class="btn btn-info btn-md" id="buttonTambah" data-toggle="modal" data-target="#addForm">Request Barang</button>
                            </div>
                    ...
                    <div class="box-footer clearfix">
                        ...
                        if (isset($totalPages)) {
                            $entity->tampilkan('depo/permintaandepo',$currentPage, $totalPages);
                        }
                        ?>
                    </div>
