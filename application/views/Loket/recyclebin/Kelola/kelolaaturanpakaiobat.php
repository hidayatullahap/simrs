                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <table class="table table-bordered table-hover" id="tabel" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <th><font color="white">Aturan Pakai Obat ID</th>
                                <th><font color="white">Nama Aturan Pakai Obat</th>
                            ...
                            if ($data->num_rows>0) {
                                ...
                                foreach ($data as $field => $values) {
                                    echo "<tr>";
                                    echo "<td width='8%'>".$values['aturan_pakai_id']."</td>";
                                    echo "<td>".$values['nama_aturan_pakai']."</td>";

                                    echo "<td><a data-toggle='tooltip' onclick='editModal($i);' title='edit'><i class='fa fa-fw fa-edit'></i></a>
                                    <a data-toggle='tooltip' title='hapus'><i class='fa fa-fw fa-remove' data-toggle='modal' data-target='.bs-example-modal-sm' data-id='".$values['aturan_pakai_id']."' 
                                    data-nama='".$values['nama_aturan_pakai']."'></i></a></td>";
                                    echo "</tr>";
                                    $i++;
                                }
                            } else {
                    ...
                    <div class="modal fade" id="addForm" role="dialog">
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                                ...
                                <h4 class="modal-title" id="headerModal">Tambah Aturan Pakai Obat</h4>
                                </div>

                                <div class="modal-body" style="text-align: right; ">
                                    <div class="item form-group">
                                        <label class="col-md-4 control-label paddingForm" for="nama_aturan_pakai">Nama Aturan Pakai Obat</label>
                                        <div class="col-md-6">
                                            <?php
                                            $data = array(
                                                'name' => 'nama_aturan_pakai',
                                                'autocomplete' => 'off',
                                                'required' => 'required',
                                                'id' => 'nama_aturan_pakai',
                                                'type' => 'text',
                                                'class' => 'form-control col-md-7 col-xs-12',
                                                'placeholder' => 'Isikan Aturan Pakai Obat',
                                            );
                    ...
                    <div id="delete" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                        <div class="modal-dialog modal-sm">
                            ...
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">Hapus Data Aturan Pakai Obat</h4>
                            </div>
                            <div class="modal-body">
                                Anda yakin ingin menghapus data Aturan Pakai Obat <br>
                                Nama : <strong class="modal-Nama">Nama Aturan Pakai Obat</strong>
                            </div>
                            <div class="modal-footer">
                    ...
                    <?php if($this->session->flashdata('pesan')) {?>
                        <div class="alert alert-success alert-dismissible" id="success-alert">
                            ...
                            <h4><i class="icon fa fa-info"></i> Data Aturan Pakai Obat</h4>
                            <?php echo $this->session->flashdata('metode')." data Aturan Pakai Obat ".$this->session->flashdata('pesan'); ?>
                        </div>
                    <?php } ?>
                    </div>
                </div>
...
function editModal(row) {
    ...
    document.getElementById("nama_aturan_pakai").value = document.getElementById("tabel").rows[row].cells[1].innerHTML;
