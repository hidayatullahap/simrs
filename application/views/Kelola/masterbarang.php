...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <a href="<?php echo base_url('/kelola/masterbarang'); ?>"><font color='black'><strong>Kelola - Barang</strong></font></a>
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <div class="form-group row">
                            ...
                            <form method="post" action="<?php echo base_url('/kelola/masterbarang/search') ?>">
                        ...
                        <table class="table table-bordered table-hover" id="tabel" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <th><font color="white">Merk/Model/Ukuran</th>
                    ...
                    <form method="post" id="formModal" action="<?php echo base_url('/kelola/masterbarang/insertdata') ?>">
                    ...
                    <div class="box-footer clearfix">
                        ...
                        if (isset($totalPages)) {
                            $entity->tampilkan('kelola/masterbarang',$currentPage, $totalPages);
                        }
                        ?>
                    </div>
...
<script>
    $('#delete').on('show.bs.modal', function (event) {
        ...
        document.getElementById("deletelink").href="<?php echo base_url('kelola/masterbarang/deletedata/'); ?>"+"/"+dataID;
    });
</script>
...
$(document).ready(function(){
    $("#buttonTambah").click(function(){
        ...
        document.getElementById("formModal").action ="<?php echo base_url('/kelola/masterbarang/insertdata') ?>";
    });
});
...
function editModal(row) {
    ...
    document.getElementById("merek_model_ukuran").value   = document.getElementById("tabel").rows[row].cells[4].innerHTML;
    ...
    document.getElementById("formModal").action ="<?php echo base_url('/kelola/masterbarang/editdata') ?>"+"/"+id;
    $("#addForm").modal();
}
</script>
