...
(function (global, factory) {
  ...
  Parsley.addMessages('id', {
    ...
    notblank: "Oops! Form ini tidak boleh kosong.",
    required: "Oops! Form ini harus diisi.",
    pattern: "Oops! Nilai invalid, tidak sesuai ketentuan.",
    min: "Oops! Nilai harus lebih besar atau sama dengan dari %s.",
    max: "Oops! Nilai harus lebih kecil atau sama dengan dari %s.",
    range: "Oops! Nilai harus diantara %s dan %s.",
    minlength: "Oops! Nilai terlalu pendek, minimal %s karakter atau lebih.",
    maxlength: "Oops! Nilai terlalu panjang, maksimal %s karakter atau kurang.",
    length: "Oops! Nilai invalid, panjang karakter harus diantara %s dan %s.",
    mincheck: "You must select at least %s choices.",
    maxcheck: "You must select %s choices or fewer.",
    check: "You must select between %s and %s choices.",
    equalto: "This value should be the same."
